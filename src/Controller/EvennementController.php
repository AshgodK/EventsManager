...
class EvennementController extends AbstractController
{
    ...
    public function indexF(EvennementRepository $evennementRepository, EventCategoryRepository $catRepo, Request $request, PaginatorInterface $paginator): Response
    {
